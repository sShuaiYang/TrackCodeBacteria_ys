function [allDataCollect] = timeLapseMultiFieldFluoImageWithoutTrackingPlot(dirFile,fixedChannel)
...
for iTime = 1:length(timeBioInfoList)
    ...
    % 删除为空的结构体dataCollect的field 并非所有的荧光通道都有数据
...
% case for empty sample 没有获取fields
if ~exist('fields','var')
